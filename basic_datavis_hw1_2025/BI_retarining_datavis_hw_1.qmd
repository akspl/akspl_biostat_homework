...
!!!!!! К сожалению, ветка с фидбеком в этом файле не имела изменений (либо я что-то недопоняла об слиянии веток), поэтому вручную преносила ваши комментарии с файла qmd :)

Задания с изменениями помечены у заголовка задания как '+ Исправления'. Под заголовкам пометила какие изменения внесла. Изменения содержат задания 1-6, 11.

### 1. + Исправления

Сделала шрифт графика крупнее
...
Сделала шрифты графиков крупнее
...
Добавлена интерпретация и увеличены шрифты графика
...
Увеличила размер шрифта графика
...
Увеличила размер шрифта графика, заменила shape 21 на 19 (чтобы для изменения цвета точки не нужно было корректировать оба параметра fill и colour). Поменяла оси местами.
...
Переименовала метки на графике, сделала шрифт графика больше.
